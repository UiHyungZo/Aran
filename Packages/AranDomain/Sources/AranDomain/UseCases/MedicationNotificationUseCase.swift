...
public protocol MedicationNotificationUseCaseProtocol {
...
public final class MedicationNotificationUseCase: MedicationNotificationUseCaseProtocol {
    ...
    public func prepareForSave(_ medication: Medication) async throws -> Medication {
    ...
    public func prepareForUpdate(_ medication: Medication) async throws -> Medication {
        var updated = medication
    ...
    public func enable(_ medication: Medication) async throws -> Medication {
        var updated = medication
    ...
    public func disable(_ medication: Medication) async throws -> Medication {
        var updated = medication
    ...
    public func cancel(for medication: Medication) async throws {
