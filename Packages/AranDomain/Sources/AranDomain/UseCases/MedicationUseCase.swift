...
public protocol MedicationUseCaseProtocol {
...
public final class MedicationUseCase: MedicationUseCaseProtocol {
    ...
    public func toggle(medication: Medication) async throws {
    ...
    public func toggleTimeSlot(medication: Medication, timeSlotID: UUID) async throws {
    ...
    public func delete(medication: Medication) async throws {
